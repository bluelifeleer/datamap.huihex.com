function createFullScreen(type) {
	...
	switch (type) {
		...
		case 'rectangle-map':
			...
			break;
		case 'logline-map':
			drawchart('data-charts-masklayer', logline_option_data(false));
			break;
		case 'standard-radar-map':
			drawchart('data-charts-masklayer', get_standard_radar_option_data(false));
			break;
		case 'gauge-map':
			drawchart('data-charts-masklayer', gauge_option_data(false));
		break;
		default:
